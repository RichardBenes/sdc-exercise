...
// Original version of this code has been obtained from
// https://github.com/smanikar/primality-testing/blob/master/src/aks-final/AKS.java
...
public class AKS
{
    ...
    public boolean checkIsPrime(Long l) {
        return checkIsPrime(BigInteger.valueOf(l));
    }
